 ...
 * FacesContext to the session-scoped session map.</li> <li>Before messages are
 * rendered, this moves the messages from the session-scoped session map back to
 * the page-scoped FacesContext.</li> Only messages that are not associated with
 * a particular component are ever moved. These are the only messages that can
 * be rendered on a page that is different from where they originated. To enable
 * this behaviour, add a <code>lifecycle</code> block to your faces-config.xml
 * file. That block should contain a single <code>phase-listener</code> block
 * containing the fully-qualified classname of this file. EDIT: This code was
 * minimally modified by Max Kuipers to address some of the Java 1.6 compiler
 * warnings. All code was originally written by Jesse Wilson.
 *
 * @author <a href="mailto:jesse@odel.on.ca">Jesse Wilson</a>
 * @author <a href="mailto:mkuipers@sourceallies.com">Max Kuipers</a>
 *         {@link http
 *         ://blogs.sourceallies.com/2010/03/rendering-global-tmessages
 *         -after-redirect/}
 */
